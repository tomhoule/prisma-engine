...
pub fn create_record(_model: &ModelRef, _args: PrismaArgs) -> (Insert<'static>, Option<GraphqlId>) {
...
pub fn update_many(_model: &ModelRef, _ids: &[&GraphqlId], _args: &PrismaArgs) -> crate::Result<Vec<Update<'static>>> {
